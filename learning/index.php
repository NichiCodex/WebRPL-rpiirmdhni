...
<html>
	<head>
		...
		<title>Learning Focus - Rekayasa Perangkat Lunak (RPL)</title>
	...
	<body class="bg-body-secondary">
				...
				<div class="collapse navbar-collapse pb-2 pb-lg-0 px-4" id="navbarSupportedContent">
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle active" aria-current="page" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false" id="nichiLearning">
							Learning Focus
							</a>
		...
		<!--First Section-->
		<div id="first-section" class="bg-nichi text-white">
            <div class="container py-5 mb-5 text-center">
                <h3 class="fw-bold mb-0">Learning Focus</h3>
            </div>
		</div>
		<!--MainFirst-->
			...
			<div class="px-4 py-5">
				<div class="row">
                    <div class="col-12 mb-4">
                        <div class="card border-0 shadow shadow-sm w-100">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="../assets/img/vector-4.svg" class="img-fluid rounded-start" alt="Web Programming">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body d-flex flex-column justify-content-center h-100">
                                        <h5 class="card-title fw-bold">Web Programming</h5>
                                        <p class="card-text">
                                            Web programming serves as the foundation of the modern digital world, enabling the creation of interactive websites, online applications, and the everyday services we enjoy. Developers play a pivotal role as digital architects, blending programming languages and technologies to design engaging and functional user experiences.
                                        </p>
                                        <a href="../learning/web-programming.php" class="btn btn-primary">
                                            <small>Learn More&nbsp;<i class="fad fa-chevron-double-right"></i></small>
                                        </a>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card border-0 shadow shadow-sm w-100">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="../assets/img/vector-6.svg" class="img-fluid rounded-start" alt="Desktop Programming">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body d-flex flex-column justify-content-center h-100">
                                        <h5 class="card-title fw-bold">Desktop Programming</h5>
                                        <p class="card-text">
                                            Desktop programming is vital for software development on personal computers and laptops. It requires mastering programming languages, intuitive interface design, and problem-solving for desktop apps. Students learn language skills and application integration, data management, and user interaction, including data storage, APIs, and input/output control.
                                        </p>
                                        <a href="../learning/desktop-programming.php" class="btn btn-primary">
                                            <small>Learn More&nbsp;<i class="fad fa-chevron-double-right"></i></small>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="col-12 mb-4">
                        <div class="card border-0 shadow shadow-sm w-100">
                            <div class="row g-0">
                                <div class="col-md-4">
                                    <img src="../assets/img/vector-9.svg" class="img-fluid rounded-start" alt="Mobile Programming">
                                </div>
                                <div class="col-md-8">
                                    <div class="card-body d-flex flex-column justify-content-center h-100">
                                        <h5 class="card-title fw-bold">Mobile Programming</h5>
                                        <p class="card-text">
                                            Mobile programming learning is the process of acquiring the skills to develop applications for mobile devices such as smartphones and tablets. It involves understanding programming languages, such as Java/Kotlin for Android and Swift for iOS, as well as applying specific frameworks and development tools. Proficiency in mobile programming allows us to create various types of applications, from social to business.
                                        </p>
                                        <a href="../learning/mobile-programming.php" class="btn btn-primary">
                                            <small>Learn More&nbsp;<i class="fad fa-chevron-double-right"></i></small>
                                        </a>
                                    </div>
                                </div>
